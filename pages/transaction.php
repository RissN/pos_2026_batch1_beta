                        ...
                        ?>
                                <div class="col-md-4">
                                    <div class="card product-card" onclick='addToCart({
                                        ...
                                        image: "asset/img/<?= $rowP["product_photo"] ?>"})'>
                                        <div class="d-flex align-items-center p-3">
                                            <img src="asset/img/<?php echo $rowP['product_photo'] ?>" class="rounded-circle me-3" width="48">
                                            <div>
                                        ...
                                        <div class="px-3">
                                            ...
                                            <p class="text-muted">Ready Stock <?php echo $rowP['qty'] ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php
    ...
    <div class="col-lg-4 p-4">
        ...
        <div class="card p-3 mt-3">
                ...
                <div class="card p-2 mb-2 order-item">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-3">
                            <img class="rounded-circle product-img" src="" width="53" height="53">
                            <div>
            ...
            <div class="mt-3 d-flex gap-2">
                ...
                <button class="btn btn-success w-50 data-bs-toggle=" data-bs-toggle="modal" data-bs-target="#exampleModal" id="btn-payment">Payment</button>
            </div>
        </div>
